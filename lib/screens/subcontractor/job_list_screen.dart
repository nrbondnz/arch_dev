...
final _sampleJobs = [
  const JobSummary(
    id: 'J001',
    name: 'Fitzroy Residential – Stage 1',
    client: 'BuildCo Pty Ltd',
  ...
  const JobSummary(
    id: 'J002',
    name: 'North Melbourne Commercial',
  ...
  const JobSummary(
    id: 'J004',
    name: 'South Yarra Mixed Use',
    client: 'Premium Build Group',
